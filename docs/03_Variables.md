...
- No puede comenzar con numeros o símbolos
- No puede contener carácteres especiales, todos son caracteres especiales menos el abecedario ingles. Ejemplo: `!"·%&-+/()=?¿...`, los unicos símbolos permitidos son `$` y `_`.
...
<!-- text autogenerated-->
<blockquote style="" ><p><a href="./03_Variables.pdf" target="_blank">Descargar esta página en PDF</a></p> </blockquote>